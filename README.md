...
| **首页序号底版** | 真机看超宽体巨号：① 与中文严格共用竖中轴（含套牌试玩那行的小号中文）② 左右两端都没被切出竖边 ③ **沉降量 `-20px` 是眼睛定的，就在这一步定死**——数字被发丝线切掉的比例是否合适 ④ 字面是 Archivo Black 而非系统回退（`wx.loadFontFace` 的失败是静默的）|
