...
miniprogram/
  ...
  config/home-voronoi.js           首页背景 Voronoi 线段几何（生成物，勿手改）
...
scripts/build-home-voronoi.js      重算首页背景 Voronoi 线场（改种子数/疏密后重跑）
...
node scripts/build-home-voronoi.js  # 重算首页背景线场（改种子数/疏密后重跑）
