...
const TOP_COMBO_FAMILIES = Object.freeze([
  ...
  { rank: 6, familyId: 'floodcaller-bounce', label: 'Valley Floodcaller Bounce Loop', pattern: 'storm-loop', result: '无限风暴与条件型法术力', winCards: [{ name: 'Brain Freeze', scope: 'intrinsic' }, { name: 'Finale of Devastation', scope: 'family' }, { name: 'Aetherflux Reservoir', scope: 'family' }] },
...
const KNOWN_COMBOS = Object.freeze([
  ...
  { id: 'scepter-reversal', familyId: 'scepter-reversal', cards: ['Isochron Scepter', 'Dramatic Reversal'], label: 'Scepter + Dramatic Reversal', speed: 'setup', result: '条件型无限法术力', recommendedBracket: 3 },
  ...
  { id: 'worldgorger-animate', familyId: 'worldgorger', cards: ['Worldgorger Dragon', 'Animate Dead'], label: 'Worldgorger + Animate Dead', speed: 'setup', result: '条件型法术力循环', recommendedBracket: 3 },
  { id: 'worldgorger-dance', familyId: 'worldgorger', cards: ['Worldgorger Dragon', 'Dance of the Dead'], label: 'Worldgorger + Dance of the Dead', speed: 'setup', result: '条件型法术力循环', recommendedBracket: 3 },
  { id: 'worldgorger-necromancy', familyId: 'worldgorger', cards: ['Worldgorger Dragon', 'Necromancy'], label: 'Worldgorger + Necromancy', speed: 'setup', result: '条件型法术力循环', recommendedBracket: 3 },
]);

// anyOfGroups 每组至少命中一张，atLeastGroups 按不同牌名计数。
// 后六条只是高置信结构模式，会提供强度证据，但不会冒充 Top 15 的完整固定家族。
const COMBO_PATTERNS = Object.freeze([
  { id: 'floodcaller-knack-artifact', familyId: 'floodcaller-bounce', countsAsCompleteFamily: true, required: ['Valley Floodcaller'], anyOfGroups: [['Retraction Helix', 'Banishing Knack'], ['Mox Amber', 'Mox Opal', 'Chrome Mox', 'Lotus Petal', "Lion's Eye Diamond", "Mishra's Bauble", "Urza's Bauble", "Tormod's Crypt", 'Welding Jar', 'Everflowing Chalice', 'Jeweled Amulet', 'Sol Ring', 'Mana Vault', 'Grim Monolith']], label: 'Valley Floodcaller Bounce Loop', speed: 'early', result: '无限风暴与条件型法术力', recommendedBracket: 4 },
